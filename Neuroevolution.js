...
var Neuroevolution = function (options) {
	...
	self.options = {
		...
		network: [4, [4], 1], // Perceptron network structure (1 hidden
		// layer).
		population: 50, // Population by generation.
		elitism: 0.1, // Best networks kepts unchanged for the next
		// generation (rate).
		randomBehaviour: 0.1, // New random networks for the next generation
		// (rate).
		mutationRate: 0.03, // Mutation rate on the weights of synapses.
